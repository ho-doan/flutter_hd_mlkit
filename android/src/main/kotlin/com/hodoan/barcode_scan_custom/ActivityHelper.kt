...
class ActivityHelper(private var applicationContext: Context?,
    ...
    private val activityResultMap: HashMap<Int, PluginRegistry.ActivityResultListener> = linkedMapOf()
    private val permissionResultMap: HashMap<Int, PluginRegistry.RequestPermissionsResultListener> = linkedMapOf()
