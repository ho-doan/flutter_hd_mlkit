...
class _AppState extends State<App> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      _numberOfCameras = await BarcodeScanCustom.instance.numberOfCameras;
      setState(() {});
    });
  }
  ...
  Future<void> _scan() async {
    try {
      final result = await BarcodeScanCustom.instance.scan(
        options: ScanOptions(
          strings: {
      ...
      setState(() {
        scanResult = ScanResult(
          rawContent: e.code == cameraAccessDenied
